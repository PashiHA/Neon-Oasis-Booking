    ...
    if (email) {
      ...
      try {
        ...
        await resend.emails.send({
          ...
          html: `
            <p>Здравствуйте, Вас приветствует Neon Oasis.
            Бронь создана ✅</p>
            ...
            <p><small>Изменение доступно за 2 часа до начала времени Бронирования.</small></p>
            <p> Телефон для контакта: +373 67 103 505.✅</p>
          `,
        });
